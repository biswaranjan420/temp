...
export class UserModel {
	...
	/*
	* participantsMenu that is enable the participants menu toolbar
	*/
	...
	*/
	...
	constructor(connectionId?: string, streamManager?: StreamManager, nickname?: string) {
		...
		this.nickname = nickname || 'IndianHealth';
	...
	public isScreen(): boolean {
		...
		return (<Publisher>this.streamManager)?.stream?.typeOfVideo === VideoType.CUSTOM;
	}
	...
	public setParticipantsMenu(menu: boolean) {
		this.participantsMenu = menu;
	}
